...
class App extends React.Component {
    ...
    validateForm() {
      ...
      if (fields["todate"] < fields["fromdate"]) {
        formIsValid = false;
        errors["todate"] = "*Select End date greater than Start date !!!"
      }
      ...
      <div id="register">
        <h1><center>Create Strategy</center></h1>
          ...
          <div className="form-inputs">
              ...
              /> */}
            <select name='criteria' value={this.state.fields.criterialist} onChange={this.handleChange}>
                {this.CriteriaList.map((option) => (
            ...
            <select name='number' value={this.state.fields.numberlist} onChange={this.handleChange}>
                {this.NumberList.map((option) => (
                  <option value={option.value}>{option.label}</option>
                ))}
              </select>
              <div className="errorMsg">{this.state.errors.Numberlist}</div>
